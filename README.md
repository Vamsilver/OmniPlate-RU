...
| **Модульные тесты pytest** | **test_ocr, test_pipeline, test_rectifier, test_verifier** | **43 / 43 PASS (100%)** | Стабильность кода | 🧪 Все тесты пройдены |
...
3. **Строгая структура датасета**:
   - Датасет — самостоятельный оцениваемый артефакт (6 504 аннотаций: 5 000 синтетика + 1 504 реальные).
