...
Направляем комплект конкурсных материалов решения полуфинального этапа:
...
• Скорость и соблюдение SLA (норматив ТЗ < 100 мс / кадр):
  ...
  - Сквозной поток на сложных сценах: ~36–55 мс (18–27 FPS).
...
• Точность распознавания (Sequence Accuracy):
  - Тип 1Б (Желтые пассажирские): 97.70% SeqAcc (CER 0.82%, Recall 100.0%).
  - Тип 1А (Квадратные двухстрочные): 71.00% – 83.50% SeqAcc (CER 3.69% – 7.81%).
  - Тип 1 (Гражданские 1-строчные): 49.84% SeqAcc.
  - Категория Other (Негативные / Нецелевые): СТРОГО 0 Fatal Penalties (100.0% True Negatives).
