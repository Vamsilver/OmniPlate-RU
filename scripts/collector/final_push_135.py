...
MODELS = [
    'toyota/mark_x', 'mitsubishi/lancer', 'mitsubishi/galant',
    'toyota/chaser', 'toyota/mark_ii', 'toyota/cresta', 'toyota/crown',
    'nissan/cube', 'toyota/bb', 'toyota/caldina', 'toyota/probox',
    'toyota/succeed', 'honda/stepwgn', 'honda/fit', 'nissan/note',
    'nissan/serena', 'subaru/forester', 'subaru/legacy'
]
...
def run():
    ...
    print(f"[*] Starting verified crops: {counter} | Unique plates: {len(plate_counts)} | Target: {target_count}", flush=True)
