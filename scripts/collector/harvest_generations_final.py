...
GENERATIONS = [
    'toyota/chaser/g380', 'toyota/chaser/g381',
    'toyota/mark_ii/g388', 'toyota/mark_ii/g389', 'toyota/mark_ii/g390',
    'toyota/cresta/g385', 'toyota/cresta/g386',
    'toyota/crown/g395', 'toyota/crown/g396', 'toyota/crown/g397', 'toyota/crown/g398',
    'toyota/caldina/g403', 'toyota/caldina/g404', 'toyota/caldina/g405',
    'toyota/altezza/g368', 'toyota/aristo/g372', 'toyota/aristo/g373',
    'nissan/stagea/g1319', 'nissan/stagea/g1320',
    'nissan/skyline/g1308', 'nissan/skyline/g1309', 'nissan/skyline/g1310',
    'nissan/laurel/g1295', 'nissan/laurel/g1296', 'nissan/laurel/g1297',
    'nissan/gloria/g1290', 'nissan/gloria/g1291',
    'nissan/cedric/g1285', 'nissan/cedric/g1286',
    'honda/stepwgn/g583', 'honda/stepwgn/g584', 'honda/stepwgn/g585',
    'honda/fit/g572', 'honda/fit/g573',
    'mitsubishi/delica/g1079', 'mitsubishi/delica/g1080'
]
...
def run():
    ...
    for gen in GENERATIONS:
        ...
        cat_url = f"https://www.drive2.ru/cars/{gen}/"
        try:
        ...
        print(f"[{gen}] Found {len(car_links)} cars (Current total: {counter}, Unique: {len(plate_counts)})", flush=True)
    ...
    print(f"\n==========================================", flush=True)
    print(f"[+] QUOTA ACHIEVED! Total Verified Crops: {counter}, Unique Plates: {len(plate_counts)}", flush=True)
    print(f"==========================================", flush=True)
