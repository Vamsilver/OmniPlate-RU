...
SHEETS_DIR = PROJECT_ROOT / "test_output" / "new_1a_verified" / "sheets"
...
def build_sheets():
    ...
    for s_idx in range(num_sheets):
        ...
        for i, c_p in enumerate(batch):
            ...
            # Scale to fit inside CELL_W-12, CELL_H-32
        ...
        out_path = SHEETS_DIR / f"verified_sheet_{s_idx:02d}.jpg"
