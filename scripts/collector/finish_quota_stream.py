...
FRESH_MODELS = [
    'honda/fit', 'honda/freed', 'honda/civic', 'honda/cr_v',
    'toyota/prius', 'toyota/corolla_axio', 'toyota/passo', 'toyota/ractis',
    'toyota/raum', 'toyota/tank', 'toyota/roomy', 'toyota/porte', 'toyota/spade',
    'nissan/note', 'nissan/serena', 'nissan/tiida', 'nissan/x_trail',
    'subaru/impreza', 'subaru/levorg', 'mitsubishi/outlander', 'mitsubishi/colt',
    'suzuki/jimny', 'suzuki/swift', 'suzuki/wagon_r', 'suzuki/hustler'
]
...
def run():
    target_count = 135  # 135 new + 21 existing = 156 total
    ...
    print(f"[*] Starting verified crops on disk: {counter} | Unique plates: {len(plate_counts)} | Target: {target_count}", flush=True)
    ...
    for page in range(1, 5):
        ...
        print(f"\n==================== SCANNING FRESH CATALOG PAGE {page} ====================", flush=True)
    ...
    print(f"\n==========================================", flush=True)
    print(f"[+] QUOTA ACHIEVED! Verified Crops: {counter}, Unique Plates: {len(plate_counts)}", flush=True)
    print(f"==========================================", flush=True)
