...
- [x] **5.4. Сборка архивов и регламент сдачи решения** (Завершено: 2026-09-19 | Артефакты: `docs/workflow/SUBMISSION_GUIDE.md`, `scripts/package_submission.py`, `package_solution.bat`, `submission/OmniPlate-RU_solution.zip`, `submission/SUBMISSION_MANIFEST.txt` | Статус: Регламент сдачи утвержден, автоматизирован скрипт сборки решения `package_submission.py`, внедрен защитный барьер Safety Max-Dimension Resize [<35 мс на 4K без потери резкости OCR], решение упаковано в компактный архив `OmniPlate-RU_solution.zip` [14.91 МБ, 163 файла, < 20 МБ SLA] с генерацией SHA-256 контрольных сумм и манифеста, 49/49 unit-тестов PASS [100%], валидация датасета `validate_dataset.py` — 100% PASS [6 492 аннотации, 0 ошибок], репозиторий полностью санирован от временных файлов, подготовлено сопроводительное письмо жюри):
  ...
  - Собран эталонный архив `submission/OmniPlate-RU_solution.zip` (14.91 МБ) со всеми 3 ONNX-моделями (13.2 МБ), кодом, тестами и пояснительной запиской;
