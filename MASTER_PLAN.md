...
- [ ] **4.5. Исследование и архитектурный дизайн расширения контекста моделей за счёт высвободившегося бюджета задержки (Context & Multi-Scale Expansion)** (В плане | Статус: Высвобожден запас по задержке >60 мс на GTX 1050 Ti; целевые направления: 1) Контекстные поля кузова [Context Margin Padding] для лучшей сегментации краёв букв; 2) Мультимасштабный инференс OCR [Multi-Scale Rescaling] для дальних планов; 3) Расширение входного контекста LPRNet без превышения лимита SLA 100 мс).
