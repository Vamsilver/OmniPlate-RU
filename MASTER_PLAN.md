...
- [ ] **3.9.5. Комплексный контрольный сквозной бенчмарк и обновление артефактов сдачи**:
  - Сквозной инференс на 1 492 реальных кадрах, валидация отсутствия Fatal Penalties, замер задержки на GPU/CPU;
  - Обновление ONNX-моделей, архива решения и `SUBMISSION_MANIFEST.txt`.
