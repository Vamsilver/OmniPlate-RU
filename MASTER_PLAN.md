...
flowchart TD
    ...
    S2 --> S3["ЭТАП 3: Обучение моделей — Детектор и OCR (В РАБОТЕ: ожидает аппрува)"]
    S3 --> S4["ЭТАП 4: Оптимизация скорости <100мс (готов прототип)"]
    S4 --> S5["ЭТАП 5: Финализация и Сдача жюри (ожидание)"]
```
